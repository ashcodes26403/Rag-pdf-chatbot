...
from RAG_APP.session_history import get_session_history

SYSTEM_PROMPT = """
Utilize the provided contextual information to respond to the user question.
If the answer is not found within the context, respond with “Sorry, I didn’t understand your question. Do you want to connect with a live agent?”.
