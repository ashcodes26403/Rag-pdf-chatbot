...
from RAG_APP.chain import ask_question, create_chain
from RAG_APP.config import Config
from RAG_APP.ingestor import Ingestor
from RAG_APP.model import create_llm
from RAG_APP.retriever import create_retriever
from RAG_APP.uploader import upload_files

load_dotenv()

LOADING_MESSAGES = [
    "Let me solve this query using nmims doc for you",
    "Processing your query...",
    "Fetching answers from your documents...",
...
def show_upload_documents():
    ...
    with holder.container():
        st.header("NMIMS FAQ Chatbot")
        st.subheader("Get answers from your documents")
        uploaded_files = st.file_uploader(
            label="Upload PDF files",
            type=["pdf"],
            accept_multiple_files=True,
            help="Upload one or more PDF files. We'll process them for you.",
        )
...
st.set_page_config(page_title="NMIMS-RagBase", page_icon="NMIMS bot 🤖")
